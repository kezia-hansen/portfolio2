    ...
    <section id="home" className="flex flex-col items-center justify-center gap-5 md:gap-12 p-5 md:p-10">
      ...
      <div className="flex gap-2 justify-center mt-5">
        <a href="https://www.linkedin.com/in/keziahansen/" className="text-gray-400 md:hover:text-orange-100">
          ...
          <SocialIcon aria-hidden="true" className="md:hover:scale-150 transition-transform duration-200" alt="linkedin logo" network="linkedin" bgColor="transparent" fgColor="#FF5722" url="https://www.linkedin.com/in/keziahansen/" style={{ height: 90, width: 90 }} />
        </a>
        <a href="https://github.com/kezia-hansen" className="text-gray-400 md:hover:text-orange-100">
          <span className="sr-only">Github</span>
          <SocialIcon aria-hidden="true" className="md:hover:scale-150 transition-transform duration-200" alt="github logo" network="github" bgColor="transparent" fgColor="#FF5722" url="https://github.com/kezia-hansen" style={{ height: 90, width: 90 }} />
        </a>
        <a href="mailto: kezia.hansen02@gmail.com" className="text-gray-400 md:hover:text-orange-100">
          <span className="sr-only">Email</span>
          <SocialIcon aria-hidden="true" className="md:hover:scale-150 transition-transform duration-200" alt="email logo" network="email" bgColor="transparent" fgColor="#FF5722" url="mailto: kezia.hansen02@gmail.com" style={{ height: 90, width: 90 }} />
        </a>
      </div>
    </section>
  );
