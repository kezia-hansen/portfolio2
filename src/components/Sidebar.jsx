...
import { IconCircleCheck, IconUser, IconBriefcase } from "@tabler/icons-react";
...
export default function Sidebar() {
  return (
    <div className="fixed flex flex-col items-center w-16 md:w-32 h-screen bg-royalBlue-500 text-yellow-50 z-10">
      ...
      <div className="flex flex-col items-center space-y-8 md:space-y-4 mt-5">
        <a className="md:hover:bg-[#FF5722] md:hover:scale-110 rounded-2xl" href="#projects">
          <IconBriefcase className="w-8 h-8 md:w-14 md:h-14" />
        </a>
        <a className="md:hover:bg-[#FF5722] md:hover:scale-110 rounded-2xl" href="#about-me">
          <IconUser className="w-8 h-8 md:w-14 md:h-14" />
        </a>
        <a className="md:hover:bg-[#FF5722] md:hover:scale-110 rounded-2xl" href="#competences">
