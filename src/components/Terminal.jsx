...
export default function Terminal() {
  return (
    <div className=" inverse-toggle shadow-lg text-orange-100 text-sm  subpixel-antialiased bg-black pb-6 pt-4 rounded-lg leading-normal overflow-hidden my-2 mx-2 md:px-5 px-4">
      ...
      <div className="flex">
        <span className="text-orange-400">creative_coder:~$</span>
